...
var query5 = _.filter(bakedGoods, function(abc){return abc.price > 4;});
...
var query6 = _.sortBy(bakedGoods, function(abc){return abc.inventory});
...
var query7 = _.groupBy(bakedGoods, function(abc){return abc.type});
...
var printMenu = function(data){
    _.each(data, function(ke, i){
      console.log(i);
      _.each(ke, function(inObj){
        //console.log(inObj);
        console.log(inObj.name + "..." + inObj.price);
      })
    })
  }
...
var comp = _.template ("<%=name + '.....$' + price%>");
_.each( bakedGoods, function(v, k) { console.log(comp(v)); });
